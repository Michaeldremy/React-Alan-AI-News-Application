...
// const API_KEY = 'NOT_SHARING_API_KEY';
// let savedArticles = [];
...
//         p.play({ command: 'newHeadlines', articles });
//         p.play(`Here is the (latest|recent) articles on ${p.term.value}`)
...
//         if (!articles.length) {
//             p.play('Sorry, please try searching for something a different catergory.')
//             return;
//         }
...
//         if (p.C.value) {
//             p.play(`Here is the (latest|recent) articles on ${p.C.value}`)
//         } else {
